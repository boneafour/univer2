...
public class ImageAdapter extends BaseAdapter {
    ...
    private String[] main = { "Лекция", "Баға",  "Жаңалықтар", "Галерея", "Біз туралы" };
    ...
    private Integer[] mThumbIds = {
            R.drawable.lecture,  R.drawable.mark1, R.drawable.news1, R.drawable.gallery,  R.drawable.about_us1,
