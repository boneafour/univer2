...
public ArrayList<CalendarCollection> date_collection_arr;
	...
	public View setSelected(View view,int pos) {
		...
		previousView.setBackgroundColor(Color.parseColor("#00FFFFFF"));
		}
...
public void getPositionList(String date,final Activity act){
		...
		for (int i = 0; i < len; i++) {
			...
			Toast.makeText(context, "У вас лекция в этот день" + event_date, Toast.LENGTH_LONG).show();
			 new AlertDialog.Builder(context)
	          .setIcon(android.R.drawable.ic_dialog_alert)
	          .setTitle("Лекция: "+event_message)
	           .setMessage("Дата: "+event_date)
